...
function AboutSection() {
  return (
    <div className="flex items-center px-32 font-lateef mt-8 ml-8 aboutsection-container" id="about">
      <div className="aboutsection-img w-1/2 mt-12">
        
        <div className="aboutsection-btn-responsive">
        <Link to={"/Shop"}> <button className="bg-book text-white py-2 px-4 border border-book w-fit text-3xl inline-block font-extralight mt-5 hover:bg-white hover:text-book hover: border-book">
            Start Shopping
          </button></Link>
          <Link to={"/Trade"}>  <button className="bg-book text-white py-2 px-4 border border-book w-fit text-3xl inline-block font-extralight mt-5 ml-8 hover:bg-white hover:text-book hover: border-book">
            Start Trading
          </button></Link>
