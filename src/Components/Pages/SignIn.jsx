...
function SignIn() {
  ...
  return (
    <div className="flex h-screen SignIn-container scale-95 font-lateef">

      <div className="w-1/2 flex items-center justify-center SignIn-form">
        <form className="max-w-md p-12 w-full">
          <h1 className="text-6xl  mb-4 text-center">WELCOME BACK</h1>
          ...
          <Link to="/SignUp"><a href="" className="underline text-xl hover:text-book">Don’t have an account yet? Sign up</a></Link>
          </div>
        </form>
